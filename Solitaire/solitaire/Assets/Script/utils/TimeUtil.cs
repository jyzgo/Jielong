...
namespace MTUnity.Utils
{
	...
	public class TimeUtil
	{
        ...
        public static int GetLocalTimeZone()
        {
            ...
            //UnityEngine.Debug.Log("<color=blue>TimeZone : " + TimeZone.CurrentTimeZone.GetUtcOffset(DateTime.Now).ToString() + ", hours : " + hours + "</color>");
            return hours;
        }
        ...
        /// 获得时区差（秒）
        /// </summary>
        /// <returns>The local time zone seconds.</returns>
        public static int GetLocalTimeZoneSeconds()
        {
            return GetLocalTimeZone() * 3600;
        }
	}
